...
def clean_data (source_path, destination_path):
    ...
    df = df.rename(columns={'No disposition':'No_disposition', 'Date mutation':'Date_mutation', 'Nature mutation':'Nature_mutation',
    'Valeur fonciere':'Valeur_fonciere', 'No voie':'No_voie', 'Type de voie':'Type_de_voie', 'Voie':'Voie',
    ...
    'Nombre de lots':'Nombre_de_lots', 'Code type local':'Code_type_local', 'Type local':'Type_local',
    'Surface reelle bati':'Surface_reelle_bati', 'Nombre pieces principales':'Nombre_pieces_principales',
